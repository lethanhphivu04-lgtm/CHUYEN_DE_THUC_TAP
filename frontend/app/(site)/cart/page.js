...
export default function CartPage() {
  ...
  const totalAmount = safeItems.reduce((sum, item) => sum + item.sku.price * item.quantity, 0);
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-slate-900">Giỏ Hàng ({safeItems.length} sản phẩm)</h1>
